...
help:
	...
	@echo "  make normalize             - (built)   normalize + redact + classify scanner output (Phase 29-30)"
	@echo "  make deduplicate-findings  - (built)   dedup findings across scanners (Phase 32)"
	@echo "  make validation-sample     - (built)   sample findings for manual validation (Phase 33)"
	@echo "  make analyse               - (built)   statistical analysis (Phase 35-36)"
	@echo "  make figures               - (built)   generate figures (Phase 37)"
	@echo "  make report                - (built)   generate reports (Phase 40)"
	@echo "  make public-dataset        - (built)   emit anonymised public dataset (Phase 38)"
	@echo "  make test                  - run the test suite"
	@echo "  make status                - show which phase scripts are built vs planned"
	@echo "  make clean-repos           - (built)   remove cloned repositories (cleanup)"
