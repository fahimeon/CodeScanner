...
**Pipeline implementation: 27 / 33 phase scripts built.** (Authoritative — generated from `scripts/workflow_status.py`.)
...
| ✅ built | `normalize_results.py` | Phase 29-30  normalize scanner output |
| ✅ built | `redact_secrets.py` | Phase 29-30  redact secret values |
| ✅ built | `classify_findings.py` | Phase 29-30  taxonomy classification |
