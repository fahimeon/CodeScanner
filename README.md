...
**Pipeline implementation: 30 / 33 phase scripts built.** (Authoritative — generated from `scripts/workflow_status.py`.)
...
| ✅ built | `deduplicate_findings.py` | Phase 32  cross-scanner dedup |
| ✅ built | `create_validation_sample.py` | Phase 33  sample findings for manual validation |
| ✅ built | `analyse_results.py` | Phase 35-36  statistics |
