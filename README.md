...
**Pipeline implementation: 33 / 33 phase scripts built.** (Authoritative — generated from `scripts/workflow_status.py`.)
...
| ✅ built | `generate_figures.py` | Phase 37  figures |
| ✅ built | `generate_reports.py` | Phase 40  reports (+ --public-only dataset) |
| ✅ built | `cleanup_repositories.py` | cleanup  remove cloned repositories |
<!-- WORKFLOW-STATUS:END -->
